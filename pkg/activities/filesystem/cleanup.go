...
// RemovalFunc is a function type for removing directories
type RemovalFunc func(path string) error

var removalFunc RemovalFunc = os.RemoveAll
...
func CleanupDirectory(ctx context.Context, dirPath string) error {
	...
	if err := removalFunc(dirPath); err != nil {
